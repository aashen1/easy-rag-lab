...
| P1 | CLI 统一 | 重写 main.py + 删 testset_cli + 改 pixi.toml | ✅ |
...
| testset_cli/ | argparse | `pixi run testset` |
...
#### P1-3：迁移 testset_cli 功能到 src/cli/testset.py
...
#### P1-5：将 agent/cli.py 委托到 src/cli/agent_cmd.py
...
| `find_full_dataset_meal()` | ~60 | **保留**（test_generation 依赖） |
...
- 3 套几乎相同的 register/lazy_import 逻辑
